/**
 * @file	nnstreamer_example_gog_tf.cc
 * @date	8 Jan 2019
...
main (int argc, char ** argv)
{
  ...
  str_pipeline =
      g_strdup_printf
      ("v4l2src name=src device=/dev/video4 ! videoconvert ! videoscale ! video/x-raw,width=%d,height=%d,format=RGB ! tee name=t_raw "
